...
{
    public class AsyncDuplicateConcurrentDictLock
    {
        ...
        {
            private readonly AsyncDuplicateConcurrentDictLock _parent;
            private readonly object _key;
            public Releaser(AsyncDuplicateConcurrentDictLock parent, object key)
            {
