...
namespace Cache.API.Controllers
{
    ...
    [ApiController]
    public class CacheScenarioThreeController : ControllerBase
    {
        private const string CACHE_KEY = "TEST";

        private static AsyncDuplicateConcurrentDictLock _lock = new AsyncDuplicateConcurrentDictLock();

        private readonly TestDbContext _context;
        private readonly IDistributedCache _cache;
        private readonly ILogger<CacheScenarioOneController> _logger;

        public CacheScenarioThreeController(IDistributedCache cache,
